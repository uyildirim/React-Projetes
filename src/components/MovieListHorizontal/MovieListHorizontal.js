...
import "./movieListHorizontal.css"

function MovieListHorizontal(props) {
  return (
    <>
        ...
        {movies.slice(0, 10).map(movie => (
          <SwiperSlide key={movie.id}>
            <div className="slider-movie-item">
              <img className="slider-image" src={`https://image.tmdb.org/t/p/w500${movie.backdrop_path}`}/>
              <h4 className="slider-movie-name">{movie.title || movie.name}</h4>
